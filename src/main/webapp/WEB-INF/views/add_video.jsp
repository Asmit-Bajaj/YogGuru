...
<%
	if(session.getAttribute("addVideoMsg") != null){
%>
<div class="modal fade " id="AddVideoModal" data-bs-backdrop="static" data-bs-keyboard="false" 
tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <%=(String)session.getAttribute("addVideoMsg")%>
      </div>
...
<script>
let myModal = new bootstrap.Modal(document.getElementById("AddVideoModal"), {});
	myModal.show();
</script>

<%
		session.removeAttribute("addVideoMsg");
	}
%>
	<div class="container-fluid">
        ...
        <div class="login">
            <div class="header">
                <h1 style="text-align: center;">Add A New Video</h1>
            </div>

            <form id="form" method="post" action="AddVideoSubmit"
