...
%>
			...
			<div class="col md-6 addBlogButton">
				<a href="AddBlog">
					<h4 style="text-align: center; color: #276678">
						<span class="plus"></span> Add A New Blog
					</h4>
				</a>
						...
						<div class="col-md-8">
							<div class="card-body">
								...
								<p class="card-text">
									<div class="row">
										<div class="col md-4">
										<a href="/YogGuru/Guru/ReadBlog?id=<%=blog.getId()%>">
	...
	<script>
		...
		function setId(id){
			...
			let ele = document.getElementById("blog_id");
			ele.href = "/YogGuru/Guru/DeleteBlog?id="+id;
			myModal.show();
		}
